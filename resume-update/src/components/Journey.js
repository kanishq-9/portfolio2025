      ...
      <div className="timeline momo-trust-display-small">
        <div className="timeline-container ">
          <div className="inner-container-1">
            <p>Completed my schooling and higher secondary at Smt. NDJA Vivekananda Vidyalaya Jr. College, Chennai. Secured a perfect 10/10 CGPA in 10th grade(2016) and achieved 87.33% in the Science stream during 12th(2018).
                <div>
        ...
        <div className="timeline-container">
          <div className="inner-container-1">
            <p>Completed a 5-month internship at BNP Paribas, Chennai (Feb–Jun 2023) as a Tester, working in both manual and automation testing.
                <div>
        ...
        <div className="timeline-container">
          <div className="inner-container-1">
            <p>Completed my full-time B.Tech at Amrita Vishwa Vidyapeetham, Chennai Campus in 2023, graduating with an 8.66 CGPA.
                <div>
